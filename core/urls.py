...
# from students.views import  student_detail, create_student, student_update, delete_student
# from students.views import StudentView, StudentDetailView, StudentListView
